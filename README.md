...
* change `Hide_Show_Admin_Bar` to `Example_Me`
...
Note that previous versions of the Boilerplate did not include `Hide_Show_Admin_Bar_Loader` but this class is used to register all filters and actions with WordPress.
